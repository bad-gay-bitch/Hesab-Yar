          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold text-gray-900 mt-2">{formatCurrency(125000000, 'IRT')}</h3>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold text-gray-900 mt-2">{formatCurrency(45000000, 'IRT')}</h3>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold text-gray-900 mt-2">{formatCurrency(80000000, 'IRT')}</h3>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-3xl font-bold mt-2 flex items-baseline gap-1">
                  {formatNumber(85)} <span className="text-sm font-normal text-white/80">/ ۱۰۰</span>
                </h3>
              </div>
            ...
            <div className="h-[300px] w-full" dir="ltr">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  />
                  <Area type="monotone" dataKey="income" name="درآمد" stroke="#10B981" strokeWidth={2} fillOpacity={1} fill="url(#colorIncome)" />
                  <Area type="monotone" dataKey="expense" name="هزینه" stroke="#EF4444" strokeWidth={2} fillOpacity={1} fill="url(#colorExpense)" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
          ...
          <CardContent>
            <div className="space-y-4 mt-4">
              {recentTransactions.map((tx) => (
                <div key={tx.id} className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100">
